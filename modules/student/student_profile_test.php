...
<head>
  ...
  <!-- TEST FIX: Experimental z-index override -->
  <link rel="stylesheet" href="../../assets/css/student/sidebar_test_fix.css" />
  <style>
    /* Visual indicator this is test page */
    body::before {
      content: "🧪 TEST PAGE - Sidebar Z-Index Fix";
      position: fixed;
      bottom: 10px;
      right: 10px;
      background: #ff9800;
